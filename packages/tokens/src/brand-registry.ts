  ...
  peerdesk: {
    ...
    products: {
      ...
      taxpeer: {
        ...
        mode: 'explicit',
        reason:
          'ブランド正本（Polastack_GTM brand-assets/ manifest v1.2.0・CEO 裁定 2026-08-19）が定めた ' +
          '千歳緑 #316745 を操作段に固定する。ロゴ資産（taxpeer/logo-*.svg）が同じ hex を持つため、' +
          'UI の操作色とロゴが byte 単位で一致する',
        ramp: {
          50: '#eaf3ec',
          100: '#c3e0cb',
          200: '#9fcfad',
          300: '#6dbc88',
          400: '#5ca174',
          500: '#316745', // 正本 主色 千歳緑（L .467・白文字 6.65:1）
          600: '#407151',
          700: '#335d42',
          800: '#20462e',
          900: '#1c3625',
        ...
        deviations: {
          500: '正本の主色 #316745（L 0.467）。白文字 6.65:1 で AA 超過',
        },
        slotOverrides: {
          // 600 (#407151) は 500 より明るい。hover は 700、押下は 800 を充てる
          '--color-bg-brand-hover': 700,
          '--color-bg-brand-active': 800,
        },
      },
