      ...
      >
                      ...
                      modules: [
                        {
                          name: 'PolaKey',
                          label: 'DX',
                          description: 'SDK・CLI・管理GUI・API Docs',
                        },
                        {
                          name: 'PolaVault',
                          label: 'CaC',
                          description: 'シークレット管理・設定ドリフト防止',
                        },
                      ],
                    },
                    {
                      ...
                      modules: [
                        {
                          name: 'PolaNest',
                          label: 'ホスティング',
                          description: 'GitOps・PRプレビュー・Zero DevOps',
                        },
                      ],
                    },
                    {
                      ...
                      modules: [
                        {
                          name: 'PolaAuth',
                          label: '認証',
                          description: 'WorkOS統合・SSO/SAML/SCIM',
                        },
                        {
                          name: 'PolaGate',
                          label: 'Gateway',
                          description: 'SDK/MCP/OpenAPI自動生成',
                        },
                      ],
                    },
                    {
                      ...
                      modules: [
                        {
                          name: 'PolaStore',
                          label: 'DB',
                          description: 'RLS/FLS・監査ログ・DB最下層セキュリティ',
                        },
                      ],
                    },
                    {
                      name: 'L4: 拡張データ & 連携層',
                      modules: [
                        { name: 'PolaCast', label: '連携', description: 'CDC・Webhook' },
                        { name: 'PolaLens', label: '分析', description: 'BigQuery + Cube' },
                        { name: 'PolaFind', label: '検索', description: '日本語typo tolerant' },
                      ],
                    },
                    {
                      name: 'L5: 運用・課金層',
                      modules: [
                        { name: 'PolaWatch', label: '監視', description: 'テナント別監視' },
                        { name: 'PolaBill', label: '課金', description: 'Stripe Billing統合' },
                      ],
                    },
                  ]
                : [
                      ...
                      modules: [
                        {
                          name: 'PolaKey',
                          label: 'DX',
                          description: 'SDK, CLI, Admin GUI, API Docs',
                        },
                        {
                          name: 'PolaVault',
                          label: 'CaC',
                          description: 'Secret mgmt, drift prevention',
                        },
                      ],
                    },
                    {
                      ...
                      modules: [
                        {
                          name: 'PolaNest',
                          label: 'Hosting',
                          description: 'GitOps, PR previews, Zero DevOps',
                        },
                      ],
                    },
                    {
                      ...
                      modules: [
                        { name: 'PolaAuth', label: 'Auth', description: 'WorkOS SSO/SAML/SCIM' },
                        { name: 'PolaGate', label: 'Gateway', description: 'Auto SDK/MCP/OpenAPI' },
                      ],
                    },
                    {
                      ...
                      modules: [
                        {
                          name: 'PolaStore',
                          label: 'DB',
                          description: 'RLS/FLS, audit logs at DB layer',
                        },
                      ],
                    },
                    {
                      name: 'L4: Extended Data Layer',
                      modules: [
                        { name: 'PolaCast', label: 'Integration', description: 'CDC, Webhooks' },
                        { name: 'PolaLens', label: 'Analytics', description: 'BigQuery + Cube' },
                        {
                          name: 'PolaFind',
                          label: 'Search',
                          description: 'Japanese typo tolerant',
                        },
                      ],
                    },
                    {
                      name: 'L5: Ops & Billing Layer',
                      modules: [
                        {
                          name: 'PolaWatch',
                          label: 'Monitoring',
                          description: 'Per-tenant monitoring',
                        },
                        {
                          name: 'PolaBill',
                          label: 'Billing',
                ...
                ? [
                    {
                      ...
                      quote: '認証基盤を3週間で構築。以前はSaaS連携だけで2ヶ月かかっていた。',
                      metrics: [
                        { label: '開発期間短縮', value: '80%' },
                        { label: '認証コード', value: '0行' },
                      ],
                      href: '/cases/startup',
                    },
                    {
                      ...
                      quote:
                        '100万件超のレコードでもPolaFindなら検索がミリ秒。業務効率が劇的に改善。',
                      metrics: [
                        { label: '検索速度', value: '<50ms' },
                        { label: '対応レコード', value: '100万+' },
                      ],
                      href: '/cases/hr',
                    },
                  ]
                : [
                    {
                      ...
                      quote:
                        'Built auth infrastructure in 3 weeks. SaaS integration alone used to take 2 months.',
                      metrics: [
                        { label: 'Dev time reduced', value: '80%' },
                        { label: 'Auth code', value: '0 lines' },
                      ],
                      href: '/cases/startup',
                    },
                    {
                      ...
                      quote:
                        'PolaFind delivers millisecond search even with 1M+ records. Dramatically improved operations.',
                      metrics: [
            ...
            testimonials={
              isJa
                ? [
                    ...
                    {
                      quote:
                        '11モジュール統合で、これまで個別に組み合わせていたSaaSの連携コストがゼロになった。',
                      author: '高橋健太',
                      role: 'VPoE',
                ...
                : [
                    {
                      quote:
                        'Auth that used to take 3 weeks now works from day one with PolaAuth — production-grade SSO/SAML.',
                    ...
                    {
                      quote:
                        '11 integrated modules eliminated the integration costs of combining separate SaaS tools.',
            ...
            rows={
              isJa
                ? [
                    ...
                    {
                      feature: 'FLS（フィールドレベルセキュリティ）',
                      values: ['自前実装', false, true],
                    },
                    { feature: '監査ログ', values: ['自前実装', false, true] },
                    {
                      feature: '全文検索（日本語typo tolerant）',
                      values: ['Elasticsearch構築', false, true],
                    },
                ...
                : [
                    ...
                    {
                      feature: 'FLS (Field-Level Security)',
                      values: ['Build yourself', false, true],
                    },
                    { feature: 'Audit Logs', values: ['Build yourself', false, true] },
                    {
                      feature: 'Full-text Search (JP typo tolerant)',
                      values: ['Elasticsearch setup', false, true],
                    },
                    {
                      feature: 'Semantic Analytics',
                      values: ['BigQuery + dbt setup', false, true],
                    },
                    { feature: 'Auto SDK Generation', values: [false, false, true] },
                    {
                      feature: 'Multi-tenant Isolation',
                      values: ['Build yourself', 'Manual', true],
                    },
              ...
              isJa
                ...
                : [
                    ...
                    },
                    {
                      name: 'ISMAP',
                      icon: <Award className="h-7 w-7 text-primary-500" />,
                      description: 'Gov cloud certification',
                    },
                  ]
            }
          />
        ...
        <AnimateOnScroll animation="fade-up">
          <PricingTable
            ...
            subtitle={
              isJa ? 'すべてのプランで全11モジュールが利用可能。' : 'All 11 modules on every plan.'
            }
            plans={[
              {
                name: 'Sandbox',
                ...
                action: { label: isJa ? '無料で始める' : 'Start Free', href: '/signup' as const },
              },
              {
                name: 'Growth',
                ...
                price: (
                  <span className="text-display-sm font-bold tracking-tight md:text-display-md">
                    ¥30,000
                    <span className="text-body-md font-normal text-neutral-500">
                      {isJa ? '/月' : '/mo'}
                    </span>
                  </span>
                ),
                ...
                features: [
                  ...
                  {
                    text: isJa ? 'メール + チャットサポート' : 'Email + chat support',
                    included: true,
                  },
              ...
              },
              {
                ...
                action: { label: isJa ? 'パートナー申請' : 'Apply', href: '/partner' as const },
              },
              {
                name: 'Self-Hosted',
                ...
                ? [
                    {
                      ...
                      answer:
                        'AIエージェント（Claude Code、Cursor等）にAPI仕様を渡すだけで、エンタープライズ品質の検索・分析・認証基盤が即座に立ち上がる業務アプリ開発プラットフォームです。11の統合モジュールで構成されています。',
                    },
                    {
                    ...
                    },
                    {
                      ...
                      answer:
                        'Polastackは11モジュール統合で、SSO・FLS・監査ログ・分析基盤・全文検索・課金が標準に含まれます。Supabaseはこれらを個別に組み合わせる必要があります。',
                    },
                    {
                      question: 'kintoneからの乗り換えは可能ですか？',
                      answer:
                        'はい。データ移行支援プログラムを提供しています。100万件超のデータ量に対応し、typo tolerant検索・FLS・監査ログも標準搭載です。',
                    },
                    {
                      question: 'フロントエンド技術スタックを変更する必要はありますか？',
                      answer:
                        'いいえ。ヘッドレスアーキテクチャなので、React / Next.js / Vue等の好きなフレームワークで開発できます。',
                    },
                    {
                      question: '開発から本番デプロイまでの期間は？',
                      answer:
                        '従来の13-26週間から3-5週間に短縮できます。開発者はビジネスロジックだけに集中できるためです。',
                    },
                  ]
                : [
                    {
                      ...
                      answer:
                        'An Enterprise Agent Stack — pass API specs to an AI agent and enterprise-grade search, analytics, and auth infrastructure spins up instantly. 11 integrated modules.',
                    },
                    {
                      question: 'Is data preserved when upgrading from Sandbox?',
                      answer:
                        'Yes. All Sandbox data and configurations are fully preserved when upgrading to Growth.',
                    },
                    {
                      question: 'How is Polastack different from Supabase?',
                      answer:
                        'Polastack includes SSO, FLS, audit logs, analytics, full-text search, and billing as integrated features across 11 modules.',
                    },
                    {
                      question: 'Can I migrate from kintone?',
                      answer:
                        'Yes. We provide migration support. Handles 1M+ records with typo-tolerant search, FLS, and audit logs built-in.',
                    },
                    {
                      question: 'Do I need to change my frontend stack?',
                      answer:
                        'No. Polastack is headless — use React, Next.js, Vue, or any framework.',
                    },
                    {
                      question: 'How long to production?',
                      answer: 'From 13-26 weeks down to 3-5 weeks. Focus solely on business logic.',
                    },
                  ]
            }
          />
        ...
        <AnimateOnScroll animation="blur-in">
          <CTASection
            ...
            subtitle={
              isJa
                ? '無料プランで即座に開始。クレジットカード不要。'
                : 'Start instantly with a free plan. No credit card required.'
            }
            actions={[
            ...
            note={
              isJa
                ? 'クレジットカード不要 | 5分でデプロイ'
                : 'No credit card required | Deploy in 5 min'
            }
          />
        </AnimateOnScroll>
      </PageLayout>
