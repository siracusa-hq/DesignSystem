            ...
            {testimonials.map((t, i) => (
              ...
              >
                <div className="relative">
                  <span
                    className="absolute -top-2 -left-1 text-5xl leading-none text-primary-200 dark:text-primary-800 select-none"
                    aria-hidden="true"
                  >
                    &ldquo;
                  </span>
                  ...
                  <Text size="body-md" tone="default" className="mb-6 pl-6 dark:text-neutral-200">
                    {t.quote}
                  </Text>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  {t.companyLogo && (
                    <div className="ml-auto shrink-0 opacity-50 grayscale">{t.companyLogo}</div>
                  )}
                </div>
              </div>
            ))}
